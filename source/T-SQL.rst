...
| 使用的常量              | 示例                                                                       |
+=========================+============================================================================+
| 字符串                  | 'O''Brien''The level for job\_id: %d should be between %d and %d.'         |
+-------------------------+----------------------------------------------------------------------------+
| Unicode 字符串          | N'Michl'                                                                   |
+-------------------------+----------------------------------------------------------------------------+
...
| 位运算符   | 位运算                                                                                     |
+============+============================================================================================+
| &          | 按位与,如果两个位置上的位均为1,则结果为1.如: :math:`(101)_2 \& (110)_2 = (100)_2`          |
+------------+--------------------------------------------------------------------------------------------+
| \|         | 按位或,如果两个位置上任意一个位置的位为1,则结果为1.如: :math:`(101)_2`                     |
+------------+--------------------------------------------------------------------------------------------+
| ^          | 按位异或,如果两个位置上数字相异,则结果为1.如: :math:`(101)_2 \text{^} (110)_2 = (011)_2`   |
+------------+--------------------------------------------------------------------------------------------+
| ~          | 按位非,对每个位位置上的位值取反.如: :math:`~ (101)_2 = (010)_2`                            |
+------------+--------------------------------------------------------------------------------------------+
...
-  :math:`\text{/* ...  */}`\ （正斜杠-星号字符对）。这些注释字符可与要执行的代码处在同一行，也可另起一行，甚至可以在可执行代码内部。
